...
var questions=[new Question("Are you ready to work 6 hours a day ?",["Yes","No"]),new Question("What is your level of education ?",["University","I can write and read"]),new Question("اختر احدى المجالات التالية التي تناسب هوايتك او تخصصك  ؟",[" Marketing "," Writing Articles "," CCTV Monitor "," Customer Service "])];function Quiz(questions){this.questions=questions;this.questionIndex=0;}
